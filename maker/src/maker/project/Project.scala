...
case class Project(
  ...
  **********************/
  ...
  def publishLocalOnly : BuildResult = publishLocalOnly("default")
  def publishLocalOnly(configurations : String) = QueueManager(List(this), PublishLocalTask, Map("configurations"-> configurations))
  ...
  def moduleDef : ModuleDef = {
    ...
    val projectDef = ProjectDef(description.getOrElse("Module " + name + " pom (generated by Maker)"), moduleLibDef, repos)
